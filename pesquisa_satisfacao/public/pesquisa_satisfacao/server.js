...
app.post('/login-pesquisa', (req, res) => {
    ...
    const validUsers = [
        ...
        { unidade: 'ANHEMBI', username: 'anhembi', password: '@nH3mb!_123' },
...
app.post('/submit-feedback', async (req, res) => {
    const { nome, sabor_refeicao, apresentacao_refeicao, temperatura_refeicao, limpeza_organizacao, atendimento_equipa, comentario, setor } = req.body;
    ...
    const sql = `
        ...
        (nome, tipo_refeicao, sabor_refeicao, apresentacao_refeicao, temperatura_refeicao, limpeza_organizacao, atendimento_equipa, comentario, setor, unidade, dataHora) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
    const values = [nome, tipo_refeicao, sabor_refeicao, apresentacao_refeicao, temperatura_refeicao, limpeza_organizacao, atendimento_equipa, comentario, setor, unidade, dataHora];
